...
def least_squares():
    ...
    ye_x_sum = 0
    ye_x_list = []
    for y_value, x_value in zip(x_list_val, y_list_val):
    ...
    print(f"Система рівнянь до розв'язання:\n"
          # f"{c0 * (n + 1) + c1 * x_sum - y_sum}\n"
          # f"{c0 * x_sum + c1 * x_sq_sum - yx_sum}\n"
          f"{eqations_phi_1[0]}\n"
          f"{eqations_phi_1[1]}\n")

    solutions = solve(eqations_phi_1, (c0, c1))
    c_0 = solutions[c0]
    c_1 = solutions[c1]
    ...
    solutions = solve(eqations_phi_2, (c0, c1, c2))
    c_0 = solutions[c0]
    c_1 = solutions[c1]
    c_2 = solutions[c2]
    ...
    solutions = solve(eqations_phi_3, (c0, c1, c2))
    c_0 = solutions[c0]
    c_1 = solutions[c1]
    c_2 = solutions[c2]
    print(f"Знайдені коефіцієнти С0 = {c_0}, С1 = {c_1}, С2 = {c_2}")
    ...
    solutions = solve(eqations_phi_4, (c0, c1, c2))
    c_0 = solutions[c0]
    c_1 = solutions[c1]
    c_2 = solutions[c2]
    print(f"Знайдені коефіцієнти С0 = {c_0}, С1 = {c_1}, С2 = {c_2}")
